...
### 4. Mapeamento de Servidores (servers.json)
Para evitar o vazamento de IPs e hostnames internos no GitHub, o mapeamento dos servidores foi externalizado.
Ao rodar o projeto pela primeira vez, um arquivo `servers.json` será gerado automaticamente com dados de exemplo. Você deve editá-lo para incluir os IPs, Sistemas Operacionais e IDs reais do Zabbix da sua infraestrutura. (Este arquivo está protegido pelo `.gitignore`).

### 5. Gestão de Usuários Iniciais
